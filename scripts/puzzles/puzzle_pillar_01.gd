...
func look():
	if $Viewport/puzzle.complete:
		Globals.playernode.queue_message("A puzzle lock. I've already solved this one.", 3, load("res://assets/VO/puzzle_solved_this_one.wav"))
	else:
		Globals.playernode.queue_message("A puzzle lock. This one is still locked.", 3, load("res://assets/VO/puzzle_this_one_still_locked.wav"))
...
func _mouse_entered_area():
	print("puzzle_pillar_01.gd: Mouse entered callback")
	is_mouse_inside = true
	
func _mouse_exited_area():
	print("puzzle_pillar_01.gd: Mouse exited callback")
	is_mouse_inside = false

func _unhandled_input(ev):
	print("puzzle_pillar_01.gd: Unhandled Input Called")
